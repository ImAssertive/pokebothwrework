...
def getInfoMenuEmoji():
    emojis = ["\N{BLACK LEFT-POINTING DOUBLE TRIANGLE WITH VERTICAL BAR}","\N{BLACK LEFT-POINTING DOUBLE TRIANGLE}","❌","\N{BLACK RIGHT-POINTING DOUBLE TRIANGLE}","\N{BLACK RIGHT-POINTING DOUBLE TRIANGLE WITH VERTICAL BAR}"]
    return emojis